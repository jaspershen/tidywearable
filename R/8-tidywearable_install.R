#' ##------------------------------------------------------------------------------
#' #' @title tidywearable_install
#' #' @description Install all packages in tidywearable.
#' #' @author Xiaotao Shen
...
#'       devtools::install_github(
#'         repo = "tidywearable/massprocesser",
#'         force = force,
#'         upgrade = upgrade,
#'         dependencies = TRUE,
#'         ...
